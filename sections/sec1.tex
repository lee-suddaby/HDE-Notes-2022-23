...
\begin{theorem}[Existence and uniqueness]
	Let the functions $F_1, \ldots, F_n$ and partial derivatives $\p_{x_1}F_1, \ldots, \p_{x_n}F_1, \ldots, \p_{x_1}F_n, \ldots, \p_{x_n}F_n$ be continuous in the region $R$ defined by $\alpha \leq t \leq \beta$, $\alpha_i \leq x_i \leq \beta_i$, $\forall i$. Then for each $(x_i^0, t) \in R$, there exists and interval $[t_0-h, t_0+h]$ in which there is a unique solution $x_i = \phi_i(t)$ of \Cref{eq:fosystem} satisfying the initial condition $\phi_i(t_0) = x_i^0$.
\end{theorem}

% $F_i(x_j(t), t)$ and $\p_{x_j} F_i(x_j(t), t)$
% $\frac{\p F_1}{\p x_1}, \ldots, \frac{\p F_1}{\p x_n}, \ldots, \frac{\p F_n}{\p x_1}, \ldots, \frac{\p F_n}{\p x_n}$
% tells us when we expect to have a unique sol to a diff eqn
